...
public class CrossOriginConfig {
    private static final String ALLOWED_HEADERS = "sessionId, isLast, x-requested-with, authorization, Content-Type, Authorization, credential, X-XSRF-TOKEN,token,username,client";
